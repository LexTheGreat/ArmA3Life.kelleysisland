...
class Life_Client_Core
{
	...
	class Actions
	{
		...
		class surrender {};
		class gather {};
		class robLSG {}; //Lakeside General
		class robSVM {}; //Smallville Market 
		class robMTG {}; //Morrison Town General
		class robMTM {}; //Morrison Town Market    
		class robLDG {}; //Los Diablos General
		class robLDM {}; //Los Diablos Market 
		class battery {};
		class takeCellphone {};
	};
