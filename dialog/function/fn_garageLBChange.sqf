...
(getControl(2800,2803)) ctrlSetStructuredText parseText format[
	...
	" +(localize "STR_Shop_Veh_UI_MaxSpeed")+ " <t color='#00BFFF'> %1 km/h</t><br/>
	" +(localize "STR_Shop_Veh_UI_HPower")+ " <t color='#00BFFF'> %2</t><br/>
	" +(localize "STR_Shop_Veh_UI_PSeats")+ " <t color='#00BFFF'> %3</t><br/>
	" +(localize "STR_Shop_Veh_UI_Trunk")+ " <t color='#00BFFF'> %4</t><br/>
	" +(localize "STR_Shop_Veh_UI_Fuel")+ " <t color='#00BFFF'> %5</t>
	",
