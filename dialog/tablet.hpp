...
enableSimulation = true;
duration = 500000;
onLoad = "uiNamespace setVariable [""TagMenu"", _this select 0]; tabletmenuisopen = 1; [] spawn fnc_nametagedit;";
onunload = "tabletmenuisopen = 0;";
objects[] = { };
class controls {
...
{
	idc = 1200;
	text = "\A3L_client2\tablet_new\apps\tag\tablettagsettings.paa";
	x = 0.288594 * safezoneW + safezoneX;
	y = 0.203 * safezoneH + safezoneY;
	w = 0.417656 * safezoneW;
	h = 0.561 * safezoneH;
};
class tagcolor: RscListbox
{
	idc = 2100;
...
class name: RscStructuredText
{
	...
	w = 0.088125 * safezoneW;
	h = 0.0300001 * safezoneH;
};
class gangpreview: RscStructuredText
{
	idc = 1002;
	text = "";
...
class home: RscPicture
{
	idc = 1203;
	text = "\A3L_client2\tablet_new\apps\tag\homebutton.paa";
	x = 0.335053 * safezoneW + safezoneX;
	y = 0.292852 * safezoneH + safezoneY;
	w = 0.06625 * safezoneW;
	h = 0.0392593 * safezoneH;
};
class save: RscPicture
{
	idc = 1204;
	text = "\A3L_client2\tablet_new\apps\tag\savebutton.paa";
	x = 0.329844 * safezoneW + safezoneX;
	y = 0.577 * safezoneH + safezoneY;
	w = 0.0797917 * safezoneW;
	h = 0.0503704 * safezoneH;
};
