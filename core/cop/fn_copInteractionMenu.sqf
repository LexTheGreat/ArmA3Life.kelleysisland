...
if(_curTarget isKindOf "House_F") exitWith {
	if((nearestObject [[16019.5,16952.9,0],"Land_Dome_Big_F"]) == _curTarget OR (nearestObject [[16019.5,16952.9,0],"Land_Research_house_V1_F"]) == _curTarget) then {
		...
		_Btn15 = _display displayCtrl Btn14;
...
_Btn11 buttonSetAction "[[],""life_fnc_stripsearch"",life_pInact_curTarget,false] spawn life_fnc_mp; closeDialog 0;";

_Btn12 ctrlSetText "Revoke Gun";
_Btn12 buttonSetAction "[[65],""life_fnc_revokeLicense"",life_pInact_curTarget,false] spawn life_fnc_mp; [[""Gun Licence Revoked!"",30,""green""] call A3L_Fnc_Msg]; closeDialog 0;";

_Btn13 ctrlSetText "Revoke Rifle";
_Btn13 buttonSetAction "[[60],""life_fnc_revokeLicense"",life_pInact_curTarget,false] spawn life_fnc_mp; [[""Rifle Licence Revoked!"",30,""green""] call A3L_Fnc_Msg]; closeDialog 0;";

_Btn14 ctrlSetText "Revoke Driver";
_Btn14 buttonSetAction "[[55],""life_fnc_revokeLicense"",life_pInact_curTarget,false] spawn life_fnc_mp; [[""Driver Licence Revoked!"",30,""green""] call A3L_Fnc_Msg]; closeDialog 0;";

_Btn15 ctrlSetText "Confiscate Phone";
_Btn15 buttonSetAction "[[], ""life_fnc_takeCellphone"",life_pInact_curTarget,false] spawn life_fnc_mp; [[""Cellphone Taken!"",30,""green""] call A3L_Fnc_Msg]; closeDialog 0;";

//Check that you are near a place to jail them.
if(!((player distance (getMarkerPos "jail_markersend") < 25) OR  (player distance (getMarkerPos "UC_Cop_Spawn") < 30))) then 
{
