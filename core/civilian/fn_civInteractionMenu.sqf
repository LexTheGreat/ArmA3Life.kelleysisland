...
_Btn1 buttonSetAction "[life_pInact_curTarget] call life_fnc_untie; [life_pInact_curTarget] call life_fnc_knockoutAction;closeDialog 0;";
...
//Strip Search
_Btn5 ctrlSetText "Strip Search";
_Btn5 buttonSetAction "[[],""life_fnc_stripsearch"",life_pInact_curTarget,false] spawn life_fnc_mp; closeDialog 0;";
...
//Take Phone
_Btn6 ctrlSetText "Take Cellphone";
_Btn6 buttonSetAction "[[],""life_fnc_takeCellphone"",life_pInact_curTarget,false] spawn life_fnc_mp; [[""Cellphone Taken!"",30,""green""] call A3L_Fnc_Msg]; closeDialog 0;";
...
//set put in vehicle
if((currentWeapon player == primaryWeapon player OR currentWeapon player == handgunWeapon player) && currentWeapon player != "") then {_Btn9 ctrlEnable true;} else {_Btn9 ctrlEnable false;};
