...
switch (_mode) do
{
	case 0:
	{
		switch (_var) do
		{
			...
			case "copperrock": {"life_inv_copperrock"};
			...
			case "grantriflelicence": {"life_inv_grantriflelicence"};
	...
	case 1:
	{
		switch (_var) do
		{
			...
			case "life_inv_copperrock": {"copperrock"};
			...
			case "life_inv_grantriflelicence": {"grantriflelicence"};
