...
switch (_var) do
{
	...
	case "life_inv_cellphone": {(localize "STR_PM_CellPhone")};
	...
	case "life_inv_jawsoflife": {("Jaws of Life")};
	...
	case "life_inv_copperrock": {(localize "STR_Item_copperrock")};
	...
	case "life_inv_grantgunlicence": {"Gun Licence"};
	case "life_inv_grantdriverlicence": {"Drivers Licence"};
	case "life_inv_grantriflelicence": {"Rifle Licence"};
