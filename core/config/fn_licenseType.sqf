...
switch (_mode) do
{
	case 0:
	{
		switch (_type) do
		{
			...
			case "fcl": {_var = "license_civ_fcl"}; //Firearm/gun license cost - New Name FCL "Firearm Carrier License"
			...
			case "fsl": {_var = "license_civ_fsl"}; //FCL - Firearm Sell License
			default {_var = ""};
		};
	};
	...
	case 1:
	{
		switch (_type) do
		{
			...
			case "license_civ_fcl": {_var = "fcl"}; //Firearm/gun license cost
