...
_hideout = (nearestObjects[getPosATL player,["Land_u_Barracks_V2_F","Land_i_Barracks_V2_F","Land_Barn_W_01","Land_Metal_Shed_F","MBG_Killhouse_1_InEditor","Land_Barn_W_02","Land_Castle_01_tower_F","MBG_Killhouse_1_InEditor"],25]) select 0;
